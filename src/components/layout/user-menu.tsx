        ...
        <div className="p-3 bg-slate-50/50 border-b border-slate-100">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            {(Object.keys(PRESET_USERS) as CoreRole[]).map((r) => {
              ...
              const RIcon = ROLE_ICONS[r] || UserCheck;
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-left text-xs transition-all border",
                    isCurrent
                ...
                >
                  <RIcon className={cn("w-3.5 h-3.5 shrink-0", isCurrent ? "text-white" : "text-slate-500")} />
                  <span className="truncate flex-1">{user.role.charAt(0) + user.role.slice(1).toLowerCase()}</span>
