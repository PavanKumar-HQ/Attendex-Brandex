...
const StudentRowItem = React.memo(function StudentRowItem({
  student,
  i,
  isAbsent,
  isOD,
      ...
      <AnimatePresence mode="popLayout">
        {students.map((student, i) => (
          <StudentRowItem
            ...
            student={student}
            i={i}
            isAbsent={absentIds.has(student.id)}
            isOD={onDutyIds.has(student.id)}
            isMedical={medicalIds.has(student.id)}
            isPresent={!absentIds.has(student.id) && !onDutyIds.has(student.id) && !medicalIds.has(student.id)}
            onToggle={onToggle}
            onMedical={onMedical}
          />
        ))}
